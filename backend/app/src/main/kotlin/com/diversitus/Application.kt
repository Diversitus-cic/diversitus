...
fun Application.module() = runBlocking {
    ...
    val messagesTableName = System.getenv("MESSAGES_TABLE_NAME") ?: throw IllegalStateException("MESSAGES_TABLE_NAME not set.")
    ...
    val messageRepository = MessageRepository(dbClient, messagesTableName)
    ...
    configureRouting(jobRepository, companyRepository, userRepository, messageRepository, matchingService)
}
